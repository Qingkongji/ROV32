...
void GetDataFromJY901(unsigned char ucData)
{
	...
	else
	{
		switch(ucRxBuffer[1])
		{
			...
			case 0x52:	JY901_Gyro.w[0]=((short)ucRxBuffer[5]<<8|ucRxBuffer[4]);      //滚转 roll
									JY901_Gyro.w[1]=((short)ucRxBuffer[7]<<8|ucRxBuffer[6]);      //偏航 yaw
			            JY901_Gyro.w[2]=((short)ucRxBuffer[3]<<8|ucRxBuffer[2]);      //俯仰 pitch
									break;
			case 0x53:	
