...
void GetDataFromJY901(unsigned char ucData)
{
	...
	else
	{
		switch(ucRxBuffer[1])
		{
			...
			case 0x52:	JY901_Gyro.w[0]=((short)ucRxBuffer[5]<<8|ucRxBuffer[4])/32768.0*2000;      //偏航   yaw
									JY901_Gyro.w[1]=((short)ucRxBuffer[7]<<8|ucRxBuffer[6])/32768.0*2000;      //俯仰   pitch
			            JY901_Gyro.w[2]=((short)ucRxBuffer[3]<<8|ucRxBuffer[2])/32768.0*2000;      //滚转   roll
									break;
			case 0x53:	
			            JY901_Angle.Angle[0]=((short)ucRxBuffer[5]<<8|ucRxBuffer[4])/32768.0*180;     //偏航   yaw 
									JY901_Angle.Angle[1]=((short)ucRxBuffer[7]<<8|ucRxBuffer[6])/32768.0*180;     //俯仰   pitch
			            JY901_Angle.Angle[2]=((short)ucRxBuffer[3]<<8|ucRxBuffer[2])/32768.0*180;     //滚转   roll  
									break;
